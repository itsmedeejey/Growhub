        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-md shadow p-6 flex flex-col">
            ...
            <div className="flex items-center gap-2 max-w-xs">
              <button className="px-3 py-1 border rounded-full hover:bg-gray-100 transition" onClick={decrease}>−</button>
              <input
                type="number"
                defaultValue={1}
                min={1}
                value={quantity}
                className="w-16 py-1  text-center border rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500"
              />
              <button onClick={increase} className=" px-3 py-1 border rounded-full hover:bg-gray-100 transition">+</button>
            </div>
            <div className="flex flex-col gap-2 mt-2">
                <button className=" text-lg text-white bg-blue-800 rounded-md p-3">Add to Cart</button>
                <button className="text-lg   border rounded-md p-3 transition ease-in-out hover:bg-green-700 hover:text-white">Buy Now</button>
            </div>
