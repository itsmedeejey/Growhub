...
export default function ReviewSection() {
  ...
  return (  
    <div className="flex flex-col justify-center   items-center mx-auto my-10 p-4">
      ...
      {/* Review Form */}
      <form onSubmit={handleSubmit} className="shadow-lg space-y-4 mb-8 border p-4 rounded-xl bg-white w-[380px] md:w-[600px] lg:w-[700px]">
        <input
          type="text"
      ...
      <div className=" grid grid-cols-1  gap-4 mx-1  mt-10 max-w-[800px]">
        {reviews.map((review) => (
          <div
            key={review.id}
            className=" h-auto w-[400px] sm:w-[600px] md:w-[700px] border rounded-lg p-4 shadow-sm space-y-1 bg-[#fff]"
          >
